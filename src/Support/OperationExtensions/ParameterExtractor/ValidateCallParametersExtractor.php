    ...
    public function handle(RouteInfo $routeInfo, array $parameterExtractionResults): array
    {
        ...
        $parameterExtractionResults[] = new ParametersExtractionResult(
            parameters: $this->makeParameters(
                rules: (new NodeRulesEvaluator($this->printer, $astNode, $validationRulesNode, $routeInfo->method, $routeInfo->className(), $routeInfo->getScope(), $this->diagnostics, $routeInfo))->handle(),
