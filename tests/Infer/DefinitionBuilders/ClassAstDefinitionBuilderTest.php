...
test('builds class definition', function () {
    ...
    $builder = new ClassAstDefinitionBuilder('Foo', new AstLocator($this->parser, $reflection->sourceLocator));
...
test('builds parent class definition', function () {
    ...
    $builder = new ClassAstDefinitionBuilder('Bar', new AstLocator($this->parser, $reflection->sourceLocator));
    $definition = $builder->build();
