...
it(
    'adds validation error response', function () {
...
it(
    'adds validation error response with facade made validators', function () {
...
it(
    'adds errors responses with custom requests', function () {
...
it(
    'doesnt add errors with custom request when errors producing methods are not defined', function () {
...
it(
    'adds authorization error response', function () {
        $openApiDocument = generateForRoute(
            function () {
...
it(
    'adds authentication error response', function () {
        $openApiDocument = generateForRoute(
            function () {
                return RouteFacade::get('api/test', [ErrorsResponsesTest_Controller::class, 'adds_authorization_error_response'])
                ->middleware('auth');
...
it(
    'adds not found error response', function () {
        $openApiDocument = generateForRoute(
            function () {
...
it(
    'adds validation error response when documented in phpdoc', function () {
...
it(
    'adds http error response exception extending HTTP exception is thrown', function () {
...
it(
    'adds http error response exception extending sympony HTTP exception is thrown', function () {
        $openApiDocument = generateForRoute(fn () => RouteFacade::get('api/test', [ErrorsResponsesTest_Controller::class, 'symphony_http_exception_response']));
...
class ErrorsResponsesTest_Controller extends Controller
{
     ...
     */
    public function symphony_http_exception_response(Illuminate\Http\Request $request)
    {
